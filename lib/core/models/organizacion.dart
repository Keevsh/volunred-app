...
class Organizacion extends Equatable {
  ...
  factory Organizacion.fromJson(Map<String, dynamic> json) {
    try {
      ...
      final email =
          _getString(json['email']) ?? _getString(json['correo']) ?? '';
      ...
      throw Exception(
        'Error parsing Organizacion from JSON: $e\nJSON: $json\nStackTrace: $stackTrace',
      );
    }
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (categoriaOrganizacion != null)
        'categoria_organizacion': categoriaOrganizacion,
    };
  }
