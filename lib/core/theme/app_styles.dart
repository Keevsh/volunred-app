...
class AppStyles {
  ...
  static BorderRadius get radiusXSmall => BorderRadius.circular(borderRadiusXSmall);
  ...
  static BorderRadius get radiusXXLarge => BorderRadius.circular(borderRadiusXXLarge);
  ...
  static InputDecoration inputDecoration({
    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: radiusSmall,
        borderSide: const BorderSide(color: AppColors.borderFocus, width: borderWidthThick),
      ),
      ...
      focusedErrorBorder: OutlineInputBorder(
        borderRadius: radiusSmall,
        borderSide: const BorderSide(color: AppColors.error, width: borderWidthThick),
      ),
    );
  }
