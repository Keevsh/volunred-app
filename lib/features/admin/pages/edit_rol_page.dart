...
class EditRolPage extends StatefulWidget {
  final Rol rol;

  const EditRolPage({super.key, required this.rol});

  @override
  State<EditRolPage> createState() => _EditRolPageState();
}

class _EditRolPageState extends State<EditRolPage> {
